...
CALL add_address(11111, TRUE, 'none', 'pick up', 'at the store', 'none', 'Ottawa', 'ON', 'K2C2T2');
CALL add_address(12321, TRUE, 'none', '1279', 'Woodroffe Ave', 'none', 'Ottawa', 'ON', 'K2C2T7');
CALL add_address(12321, FALSE, 'none', '1277', 'Woodroffe Ave', 'none', 'Ottawa', 'ON', 'K2C2T7');
